...
## Problem
We are not able to know precisely what makes a great movie and makes the most money at the box office. 

## Objective
With metadata on over 7,000 past films from [The Movie Database](https://www.themoviedb.org/), the objective is to predict their overall worldwide box office revenue.

This objective includes to answer the following questions:
...
We observe that the strongest correlation is between the budget ($x_1$) and the revenue ($y$).
