...
Assuming that the main actor is given as the first one in the list of casting, we expect that more a main actor have played in movies, better the revenue is. Therefore, we want to obtain the list of main actors with the number of movies in which they played.
